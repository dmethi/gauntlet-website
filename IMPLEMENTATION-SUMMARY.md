...
Successfully added live win probability and score over time charts to the
matchup detail page by integrating with existing database infrastructure and
reusing production-ready chart components from the recap reports.
...
1. `apps/web/src/app/api/matchup-timeseries/[leagueId]/[week]/[matchupId]/route.ts` -
   API endpoint
...
1. `apps/web/src/app/matchups/[leagueId]/[week]/[matchupId]/page.tsx` -
   Integrated charts (main matchup page)
2. `apps/web/src/app/matchup/[matchupId]/page.tsx` - Integrated charts
   (alternate page)
...
Successfully implemented live win probability and score over time charts on the
matchup detail page. The implementation:
...
**The feature is now ready for use and will show real data for any Week 6+
matchup!**
