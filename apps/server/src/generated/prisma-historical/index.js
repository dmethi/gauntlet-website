...
const config = {
  generator: {
    ...
    output: {
      value:
        '/Users/dhruv.methi/Documents/GitHub/gauntlet-website/apps/server/src/generated/prisma-historical',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
    ...
    previewFeatures: [],
    sourceFilePath:
      '/Users/dhruv.methi/Documents/GitHub/gauntlet-website/apps/server/prisma/schema-historical.prisma',
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = ['src/generated/prisma-historical', 'generated/prisma-historical'];
...
path.join(process.cwd(), 'src/generated/prisma-historical/libquery_engine-darwin-arm64.dylib.node');
// file annotations for bundling tools to include these files
path.join(__dirname, 'schema.prisma');
path.join(process.cwd(), 'src/generated/prisma-historical/schema.prisma');
