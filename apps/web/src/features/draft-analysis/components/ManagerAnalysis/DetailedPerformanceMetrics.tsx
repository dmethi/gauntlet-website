        ...
        <div>
          ...
          <DataList className="sm:hidden">
            {profiles.slice(0, 100).map((profile, index) => (
              <DataListItem
                key={`detailed-mobile-${profile.manager || 'mgr'}-${profile.league || 'lg'}-${index}`}
              >
                <DataListHeader>
                  <div className="min-w-0">
                    ...
                    <DataListDescription>
                      {profile.league} · {profile.cluster.cluster_label}
                    </DataListDescription>
                  </div>
                </DataListHeader>
                <DataListMetrics>
                  <DataListMetric>
                    <DataListMetricLabel className="text-xs">Gini</DataListMetricLabel>
                    <DataListMetricValue>
                      {profile.concentration.giniSpend.toFixed(3)}
                    </DataListMetricValue>
                  </DataListMetric>
                  <DataListMetric>
                    <DataListMetricLabel className="text-xs">Top 2</DataListMetricLabel>
                    <DataListMetricValue>
                      {(profile.concentration.top2_share * 100).toFixed(1)}%
                    </DataListMetricValue>
                  </DataListMetric>
                  <DataListMetric className="text-right">
                    <DataListMetricLabel className="text-xs">Starters</DataListMetricLabel>
                    <DataListMetricValue>
                ...
                <details className="group mt-2">
                  ...
                  <DataListMetrics className="mt-1 grid-cols-1">
                    <DataListMetric>
                      <DataListMetricLabel className="text-xs">
                        Last starter pick
                      </DataListMetricLabel>
                      <DataListMetricValue>{profile.pacing.last_starter_index}</DataListMetricValue>
                    </DataListMetric>
                  </DataListMetrics>
                </details>
              </DataListItem>
          ...
          <Table
            surface="responsive"
            scrollLabel="Detailed draft performance table"
