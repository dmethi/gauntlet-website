...
const countDonuts = (matchup: ProcessedMatchup): number => {
...
const getOptimalScore = (matchup: ProcessedMatchup): number => {
...
const getCombinedPositionalPoints = (
 ...
 */
export const getCategoriesGrouped = (): Map<string, HallOfFameCategory[]> => {
