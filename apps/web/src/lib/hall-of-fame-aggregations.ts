 ...
 */
export function calculateStreaks(matchups: ProcessedMatchup[]): StreakData[] {
 ...
 */
export function calculateSeasonalData(matchups: EnhancedMatchup[]): SeasonalData[] {
 ...
 */
function calculateExpectedWinsForSeason(
  matchups: ProcessedMatchup[],
  rosterId: number,
  leagueId: string,
  season: string,
 ...
 */
export function findSeasonalRecords(
