...
This document tracks which parts of the codebase have design documentation vs.
"unknown" areas that need coverage as we touch them.
...
- ✅ `docs/constraints/integrations.md` - API clients and cross-feature data
  flow
...
1. **Historical data strategy** - How should we cache/persist historical
   snapshots?
