...
## Overview
Rewrite `apps/server/README.md` to accurately document the current minimal state: 3 TypeScript files, 3 database models, 1 GitHub workflow.
...
## Why "server"?
Legacy naming. This was originally an Express HTTP server but has been simplified to background jobs only.
```
