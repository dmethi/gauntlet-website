...
```
I'm working on WEB-EXTRACT-001. Please read the task file and execute the steps.
```
...
**Estimated Context Usage**: XXX lines read, XXX lines written, 20 min total
