...
```
I'm working on WEB-HOOK-002. Please read the task file and execute the steps.
```
...
**Estimated Context Usage**: XXX lines read, XXX lines written, 45 min total
