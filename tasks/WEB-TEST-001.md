...
**Dependencies**: WEB-COMP-001, WEB-COMP-002, WEB-SETUP-003
...
```
I'm working on WEB-TEST-001. Please read the task file and execute the steps.
```
...
**Blocks**: TBD  
**Blocked By**: WEB-COMP-001, WEB-COMP-002, WEB-SETUP-003  
**Related**: TBD
...
**Estimated Context Usage**: XXX lines read, XXX lines written, 3 hours total
