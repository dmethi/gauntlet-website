...
**Dependencies**: WEB-SETUP-003, WEB-EXTRACT-001
...
```
I'm working on WEB-UTIL-001. Please read the task file and execute the steps.
```
...
**Blocks**: TBD  
**Blocked By**: WEB-SETUP-003, WEB-EXTRACT-001  
**Related**: TBD
...
**Estimated Context Usage**: XXX lines read, XXX lines written, 40 min total
