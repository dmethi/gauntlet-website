...
The current 4 WEB-UTIL tasks are **NOT comprehensive enough** to cover all utility extraction work identified in the codebase. 
...
3. **`lib/chart-colors.ts`** (323 lines) - Complete implementation, just needs relocation

### 🔴 Critical Issues Found

1. **Duplicate formatOdds() function** in 2 files (matchup components)
2. **Inline formatting** scattered across 15+ components (`.toFixed()` appears 80+ times)
3. **5 separate Hall of Fame files** need consolidation
4. **Mega-file manager-analytics.ts** (1,346 lines) mixes data fetching with calculations
...
**Cleanup (Day 5):**
5. WEB-UTIL-002 (40 min) - Color relocation
